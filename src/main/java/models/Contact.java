...
public interface Contact extends Type {
	protected ContactSystem system; //What kind of contact this is - what communications system is required to make use of the contact
	protected ContactUse use; //The actual contact details, in a form that is meaningful to the designated communication system (i.e. phone number or email address).
	private String value; //Identifies the context for the address
	private Period period; //Time period when the contact was/is in use

	protected enum ContactSystem {
